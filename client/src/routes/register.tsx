...
function RegisterPage() {
  ...
  const schema = z.object({
    name: z
      .string()
      .min(2, t("translation:register.nameTooShort"))
      .max(50, t("translation:register.nameTooLong")),
    email: z.string().email(t("translation:auth.emailInvalid")),
    password: z
      .string()
      .min(6, t("translation:auth.passwordTooShort"))
      .max(100, t("translation:register.passwordTooLong")),
  });
